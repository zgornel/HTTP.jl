...

{
    ...
    "title": "HTTP.Connect",
    "category": "Module",
    "text": "getconnection creates a new TCPSocket or SSLContext for a specified host and port.\n\nNo connection streaming, pooling or reuse is implemented in this module. However, the getconnection interface is the same as the one used by the connection pool so the Connect module can be used directly when reuse is not required.\n\n\n\n"
},

{
    "location": "index.html#Basic-Connections-1",
    "page": "Home",
    "title": "Basic Connections",
    "category": "section",
    "text": "Source: Connect.jlHTTP.Connect"
},
...
{
    "location": "index.html#Connections-Interface-1",
    "page": "Home",
    "title": "Connections Interface",
    "category": "section",
    "text": ""
},

{
    "location": "index.html#HTTP.Connect.getconnection-Tuple{Type{TCPSocket},AbstractString,AbstractString}",
    "page": "Home",
    "title": "HTTP.Connect.getconnection",
    "category": "Method",
    "text": "getconnection(type, host, port) -> IO\n\nCreate a new TCPSocket or SSLContext connection.\n\nNote: this Connect module creates simple unadorned connection objects. The Connections module has the same interface but supports connection reuse and request interleaving.\n\n\n\n"
},

{
    "location": "index.html#Low-Level-Connect-Interface-1",
    "page": "Home",
    "title": "Low Level Connect Interface",
    "category": "section",
    "text": "HTTP.Connect.getconnection(::Type{TCPSocket},::AbstractString,::AbstractString)"
},
...
{
    "location": "index.html#HTTP.Connect.getconnection-Union{Tuple{T}, Tuple{Type{HTTP.ConnectionPool.Transaction{T}},AbstractString,AbstractString}} where T<:IO",
    "page": "Home",
    "title": "HTTP.Connect.getconnection",
    "category": "Method",
